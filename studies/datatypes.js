...
* or complex.
* 
* // Simple datatypes are stored as values and are immutable (we cannot change
...
* if we need to built our own custom types of things? For example, in Amazon's
...
function makeProduct(name, weight, cost) { 
  ...
  return {
   ...
   weight: "4 oz",
   cost: "$500",
   makePriceChange: function(newPrice) {
...
function returnsCodeBody(param1) {
       return "code body";
   }
...
* 
* Therefore, we must perform special tests to eliminate the possiblity that a 
