...
function greeter(hour) {
    ...
    /** use an if, else if, else statement the first conditional that is true 
     * will cause the statement to stop running
     * So, only use the high end of each range in your conditionals
     * hour <= 11
     * hour <= 16, etc.
