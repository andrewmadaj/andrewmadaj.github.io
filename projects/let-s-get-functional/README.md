...
## Step 2 - Solve
 ...
 - To test your solutions run `npm start --prefix ./andrewmadaj.github.io/projects/let-s-get-functional` in your terminal  
...
// loop through given array
    // loop through array[i].friends // loop through the element in array's "friend" key's value which is
        // if (array[i].friends[i].name === name) // if the current iteration of the friends array's name is equal to given name
            // push the name of that array[i] onto holder array
// return holder array
...
// set object.male = reduce(array, function(a, b) {if (array[b].gender === male) {a + 1}))
